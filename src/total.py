...
train_dir = (
    "/path/to/project/recycle_results/cycle_0/IG_outputstep/train/correct_class_residue"
)

val_dir = (
    "/path/to/project/recycle_results/cycle_0/IG_outputstep/val/correct_class_residue"
)
...
out_dir = (
    "/path/to/project/IG_class_analysis_step"
)
